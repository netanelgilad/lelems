/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 28785c345f98f697b5d5a3e99a543c85)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	KEY_ENCRYPTION_SECRET: string;
	LELEM: DurableObjectNamespace<import("./worker/index").Lelem>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Lelem";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KEY_ENCRYPTION_SECRET">> {}
}
